...
int main()
{
    ...
    sized_tests(2048, 2048, 20480, true);
    sized_tests(2048, 2048, 40960, true);
    sized_tests(1024, 1024, 20480, true);
    sized_tests(512, 512, 40960, true);
    sized_tests(256, 256, 40960, true);
