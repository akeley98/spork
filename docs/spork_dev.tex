...
\begin{itemize}
  ...
  \item \texttt{\{units\}} = \redBox{\texttt{clusters}}, \texttt{blocks}, \texttt{warpgroups}, \texttt{warps}, \texttt{threads} {\small (TODO clusters need thought)}
  \item Generalize \texttt{seq}, \texttt{par} to \myKey{loop mode}
\end{itemize}
Must be \myKey{strictly nested} (except \redBox{clusters}?)
\begin{itemize}
