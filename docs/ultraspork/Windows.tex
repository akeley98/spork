...
These ``window references'' have logical attributes
\begin{itemize}
...
\magicSubsection{Dimension Reshape}{sec:Dimension Reshape}
...
The common 128-byte swizzle function works by XOR-ing bits 4, 5, and 6 of a physical SMEM address with bits 7, 8, 9.
This pattern has atomicity of 16 bytes, and a period of 1024 bytes.
