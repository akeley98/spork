...
\begin{equation*}
    A(x_1, x_2, x_3, ...) = \sum_{i} (x_i + A_i)^2 \text{  (where $A_i$ are the generated free variables)}
\end{equation*}
...
\end{itemize}
and the resulting extended polynomial function is a function of control variables \lighttt{m}, \lighttt{m\_offset} (from an unseen \lighttt{cuda\_tasks} loop, Section~\ref{sec:SeqPar}), \lighttt{k\_iter}, and \lighttt{k\_thr}.
