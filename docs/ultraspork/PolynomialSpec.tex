...
\end{equation*}
For algorithms without data-dependent indexing or branching, it should be possible to specify the expected output buffer values as an extended polynomial function of the input buffers.
...
\magicSubsection{Value Correctness Checking}{sec:ValueCorrectnessChecking}
