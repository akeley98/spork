...
Otherwise, my initial approach would be to symbolically evaluate the entire program for a concrete problem size, due to the difficulty of reasoning about programs with mutable array accesses.
