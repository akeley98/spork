...
\usepackage[paperheight=148mm, paperwidth=263mm, top=10mm, bottom=10mm, left=28mm, right=28mm]{geometry}
\usepackage{enumitem}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{amsfonts}
...
\newcommand{\myTitle}[1]{{\large \color{titleColor} \hspace{-22mm} \textbf{\textsf{#1}}}}
\newcommand{\myTitleExtra}[1]{{\large \color{extraTitleColor} \hspace{-22mm} \textbf{\textsf{#1}}}}
\newcommand{\myBiggerTitle}[1]{{\huge \color{titleColor} \hspace{-22mm} \textbf{\textsf{#1}}}}
\newcommand{\myBiggerTitleExtra}[1]{{\huge \color{extraTitleColor} \hspace{-22mm} \textbf{\textsf{#1}}}}
