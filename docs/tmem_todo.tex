...
Since each 32 lanes of TMEM is private to a warp, I imagine we'll model TMEM as being distributed by warps, with an array dimension of size 4 corresponding to the distributed dimension.
So the \lighttt{native\_unit} for this is probably \lighttt{cuda\_warp} (or \lighttt{2 * cuda\_warp\_in\_cluster} for CTA-pair versions of the Exo TMEM class).
