...
\node (unrelated) [bluestyle, align=center, right=of arrive, xshift=2mm, yshift=-9mm] { (unrelated\\work) };
\node (await) [yellowstyle, text width=10mm, minimum height=40mm, align=center, right=of unrelated, xshift=2mm, yshift=+9mm] {};
