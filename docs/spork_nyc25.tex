...
Exo exists today; extending it to model GPUs in a disciplined way. \yellowBox{CPU-based accelerators}
...
\yellowBox{Transition; future parallel rewrites not checked here.}

\yellowBox{Before and after for tiling}

}

\newpage
\myBiggerTitle{GPU: Blocks \& Threads \yellowBox{colors, remove code comments}}
