...
\newpage
\myBiggerTitle{GPU and Memory \yellowBox{\small Remove GPU loops here}}
...
\newpage
\myBiggerTitle{GPU task (block) loops}
...
\newpage
\myBiggerTitle{Prepare for cp.async}
