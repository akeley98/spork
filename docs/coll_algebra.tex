...
The implemented \lighttt{CollUnit} object differs from the above description:

\filbreak
\begin{itemize}
\item The box cannot contain None (be agnostic) initially. This should only arise due to domain completion.
\filbreak
\item The domain and box are tuples of \lighttt{CollSizeExpr}, which are converted to integers by looking up the \myKeyA{collective environment}, which maps \lighttt{clusterDim} and \lighttt{blockDim} to concrete values.
\end{itemize}
...
\node(t02L) [yellowcolltiling, right=of t01R] {$I^P$=0,64\\$I$=0,0\\$j$=0};
...
\node(t12L) [greencolltiling, right=of t11R] {$I^P$=1,64\\$I$=0,0\\$j$=1};
...
\sffamily
\begin{tikzpicture}[node distance=2mm]
\node(t00L) [yellowcolltiling] {$I^P$=0,0\\$I$=0,0\\$j$=0};
\node(t00R) [yellowcolltiling, right=of t00L, xshift=4mm] {$I^P$=0,31\\$I$=0,31\\$j$=0};
\draw [dotted] (t00L) -- (t00R);
\node(t01L) [greencolltiling, right=of t00R] {$I^P$=0,32\\$I$=0,0\\$j$=1};
...
The resulting collective unit is a group of 4 warps cooperating along the CTA-in-cluster dimension.
}
