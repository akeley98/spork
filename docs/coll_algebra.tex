...
Each \lighttt{cuda\_threads} iterator variable (previous example : \texttt{\greenBox{m}, \violetBox{n}}) has two relevant pieces of state:
\begin{itemize}
...
\filbreak
All usages must deduce the same tuple of \lighttt{CollIndexExpr}.
