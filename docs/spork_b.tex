...
For data allocations, the memory type specifies a collective unit (the \myKeyA{native unit}) from which a collective type $\delta_0$ is unpacked with alignment and 1-padding (def~\ref{sec:gCollUnit}).
...
TODO mbarrier guarding.

\subsection{Subdivision Requirement}
