...
\begin{itemize}
  \item \lighttt{set\_loop\_mode}: use new loop mode object.
  \item \lighttt{update\_loop\_mode}: modify attribute of loop mode.
  \item \lighttt{parallelize\_loop}: use \lighttt{Par()} as the loop mode (legacy).
\end{itemize}
