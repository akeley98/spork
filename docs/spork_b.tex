...
\label{sec:SeqParEquivalenceOverview}
...
\label{sec:DistributedMemoryOverview}
...
\subsection{Arrive Statement}
\label{sec:gArriveStmt}
...
\subsection{Distributed Collective Units}
\label{sec:gDistributedCollUnits}
...
\subsection{Distributed Dimension}
\label{sec:gDistributedDimension}
...
% >F
\subsection{First Synchronization Timeline}
\label{sec:gFirstSyncTL}
...
\subsection{Fence Statement}
\label{sec:gFenceStmt}
...
\subsection{Second Synchronization Timeline}
\label{sec:gSecondSyncTL}
...
\subsection{Thread Mapping Function}
\label{sec:gThreadMappingFunction}
