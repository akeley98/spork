...
\begin{align*}
    ...
    & \textsf{collMap}((\omega_0, ..., \omega_{M-1}), \sigma_c) \mapsto \{ \textsf{toLocal}(\omega.D, c) \mid
...
In this case, the collective tiling $\omega'$ of the child statements is like $\omega$, but with a new $\textit{op}: \mathcal{O}$ added to $\omega_k$, with
\begin{itemize}
