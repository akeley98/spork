...
Each barrier array element contains its own arrive count and await count, both initially 0 (Section~\ref{sec:SyncEnv}).
...
\label{sec:SplitBarrierBasicRequirements}
