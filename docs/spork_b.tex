...
\begin{itemize}
   ...
   \item have an \lighttt{codegen} member function (Section~\ref{sec:InstrCodegen}).
\end{itemize}
...
\begin{itemize}
  \item \lighttt{Seq(pragma\_unroll: Optional[int])}: sequential loop (def~\ref{sec:gSeqLoop}).
