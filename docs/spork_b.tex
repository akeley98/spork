...
\mainKey{Base Offset Equivalence:} Compute the linear offset of $\omega$ as $\sum_{i} O_i \omega.P_i$, $O$ denoting the base offset derived from $\omega$ and $\omega.P_i$ the thread pitch (def~\ref{sec:gThreadPitch}).
