...
Set of threads assigned to execute one statement instance (def~\ref{sec:gStmtInstance}) or to allocate one shard of a variable (Section~\ref{sec:DistributedMemory}).
