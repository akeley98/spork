...
\end{itemize}
The multicast versions of TMA instructions involve \lighttt{ncta}-many CTAs, with the sequence of involved CTAs' \lighttt{cluster\_ctarank} values incrementing by \lighttt{cta\_stride}.
