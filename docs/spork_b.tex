...
% TODO diagram for collective tiling
% deriveCollTiling
...
\node(t001a) [CollTypeExampleStyle, right=of t000b, xshift=2mm, yshift=-3mm] {(0, 128)\\128 $ \in \mu$\\\blueBox{0}, 0, 1, 0};
\node(t001b) [CollTypeExampleStyle, right=of t001a, xshift=6mm] {(0, 255)\\255 $ \in \mu$\\0, 0, 1, 127};
\draw [dotted] (t001a) -- (t001b);
\node(t002a) [CollTypeExampleStyle, right=of t001b, xshift=2mm, yshift=-3mm] {(0, 256)\\256 $ \in \mu$\\0, 0, \violetBox{2}, \redBox{0}};
\node(t002b) [CollTypeExampleStyle, right=of t002a, xshift=6mm] {(0, 383)\\383 $ \in \mu$\\0, 0, \violetBox{2}, \redBox{127}};
...
\node(t100a) [CollTypeExampleStyle, below=of t010a, yshift=-4mm, xshift=-4mm] {(2, 0)\\768 $ \in \mu$\\\blueBox{1}, \yellowBox{0}, 0, 0};
\node(t100b) [CollTypeExampleStyle, right=of t100a, xshift=6mm] {(2, 127)\\895 $ \in \mu$\\1, 0, 0, 127};
\draw [dotted] (t100a) -- (t100b);
\node(t101a) [CollTypeExampleStyle, right=of t100b, xshift=2mm, yshift=-3mm] {(2, 128)\\896 $ \in \mu$\\\blueBox{1}, 0, 1, 0};
...
\node(t110a) [CollTypeExampleStyle, below=of t100a, yshift=-2mm] {(3, 0)\\1152 $ \in \mu$\\\blueBox{1}, \yellowBox{1}, 0, 0};
...
\node(t201a) [CollTypeExampleStyle, right=of t200b, xshift=2mm, yshift=-3mm] {(4, 128)\\1664 $ \in \mu$\\\blueBox{2}, \yellowBox{0}, 1, 0};
\node(t201b) [CollTypeExampleStyle, right=of t201a, xshift=6mm] {(4, 255)\\1791 $ \in \mu$\\2, 0, 1, 127};
\draw [dotted] (t201a) -- (t201b);
\node(t202a) [CollTypeExampleStyle, right=of t201b, xshift=2mm, yshift=-3mm] {(4, 256)\\1792 $ \in \mu$\\2, 0, 2, \redBox{0}};
\node(t202b) [CollTypeExampleStyle, right=of t202a, xshift=6mm] {(4, 383)\\1919 $ \in \mu$\\2, 0, 2, \redBox{127}};
\draw [dotted] (t202a) -- (t202b);
\node(t210a) [CollTypeExampleStyle, below=of t200a, yshift=-2mm] {(5, 0)\\1920 $ \in \mu$\\2, 1, \violetBox{0}, 0};
\node(t210b) [CollTypeExampleStyle, right=of t210a, xshift=6mm] {(5, 127)\\2047 $ \in \mu$\\2, 1, 0, 127};
\draw [dotted] (t210a) -- (t210b);
\node(t211a) [CollTypeExampleStyle, right=of t210b, xshift=2mm, yshift=-3mm] {(5, 128)\\2048 $ \in \mu$\\2, \yellowBox{1}, \violetBox{1}, 0};
\node(t211b) [CollTypeExampleStyle, right=of t211a, xshift=6mm] {(5, 255)\\2175 $ \in \mu$\\2, 1, 1, 127};
\draw [dotted] (t211a) -- (t211b);
\node(t212a) [CollTypeExampleStyle, right=of t211b, xshift=2mm, yshift=-3mm] {(5, 256)\\2176 $ \in \mu$\\2, 1, \violetBox{2}, 0};
...
\node(t301a) [CollTypeExampleStyle, right=of t300b, xshift=2mm, yshift=-3mm] {(6, 128)\\2432 $ \in \mu$\\\blueBox{3}, 0, 1, 0};
...
\draw[line, bluestyle] (t001a.north west) -- ($(t001a.north west) - (3mm, 0mm)$);
\draw[line, bluestyle] (t311a.south west) -- ($(t311a.south west) - (3mm, 0mm)$);
\draw[line, bluestyle] ($(t001a.north west) - (3mm, 0mm)$) -- ($(t311a.south west) - (3mm, 0mm)$);
\node(D0) [anchor=center] at($(t001a.north west)!0.5!(t311a.south west) - (3mm, 0mm)$) {\blueBox{$\delta.D_0=4$}};

\draw[line, yellowstyle] (t201a.north east) -- ($(t201a.north east)+(4mm, 0mm)$);
\draw[line, yellowstyle] (t211a.south east) -- ($(t211a.south east)+(4mm, 0mm)$);
\draw[line, yellowstyle] ($(t201a.north east)+(4mm, 0mm)$) -- ($(t211a.south east)+(4mm, 0mm)$);
\node(D1) [anchor=center] at($(t201a.north east)!0.5!(t211a.south east)+(4mm, 0mm)$) {\yellowBox{$\delta.D_1=2$}};

\draw[line, violetstyle] (t210a.south west) -- ($(t210a.south west)-(0mm, 2mm)$);
\draw[line, violetstyle] (t212b.south east) -- ($(t212b.south east)-(0mm, 2mm)$);
\draw[line, violetstyle] ($(t210a.south west)-(0mm, 2mm)$) -- ($(t212b.south east)-(0mm, 2mm)$);
\node(D2) [anchor=center] at($(t210a.south west)!0.6!(t212b.south east)-(0mm, 2mm)$) {\violetBox{$\delta.D_2=3$}};

\draw[line, redstyle] (t202a.south west) -- ($(t202a.south west) + (2mm, -3.5mm)$);
\draw[line, redstyle] (t202b.south east) -- ($(t202b.south east) + (-2mm, -3.5mm)$);
\draw[line, redstyle] ($(t202a.south west) + (2mm, -3.5mm)$) -- ($(t202b.south east) + (-2mm, -3.5mm)$);
\node(D3) [anchor=center] at($(t202a.south west)!0.5!(t202b.south east) + (0mm, -3.5mm)$) {\redBox{$\delta.D_3=128$}};
...
% Split Barrier Basic Requirements

% Solitary Split Barrier Requirement

% Guarding Split Barrier requirement

% Multicast Convergence Split Barrier Requirement
