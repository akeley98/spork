...
\myChapterLink{sec:ManagedRingBuffers}{Managed Ring Buffers}

``Implicit'' ring buffering, \lighttt{@ ring\_buffer\_by}, \lighttt{ring\_guarded\_by}
...
\clearpage
\input{spork_b/ManagedRingBuffers.tex}
\clearpage
