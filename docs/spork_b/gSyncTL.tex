...
\texttt{cuda\_stream\_sync} &  & full & full & full & full & full & full & full & full & full & full &  & full\\
\texttt{cuda\_in\_order} &  &  & full & full & full &  &  &  &  &  &  & temp. & temp.\\
\texttt{cuda\_temporal} &  &  & temp. & temp. & full &  &  &  &  &  &  & temp. & temp.\\
\texttt{Sm80\_cp\_async} &  &  &  &  & full & full &  &  &  &  &  &  & \\
\texttt{Sm80\_generic} &  &  & full & full & full & full &  &  &  &  &  & temp. & temp.\\
...
\texttt{cuda\_generic\_and\_async\_proxy} &  &  & full & full & full &  &  &  &  &  &  & temp. & full\\
\hline
\end{tabular}
}
...
\mainKey{See also:} qualitative timeline mask, def~\ref{sec:gQualTLMask}. Groups qualitative timelines per memory type.
