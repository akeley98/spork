...
\texttt{cuda\_in\_order} &  &  & full & full & full &  &  &  &  &  &  & temp.\\
\texttt{cuda\_temporal} &  &  & temp. & temp. & full &  &  &  &  &  &  & temp.\\
\texttt{Sm80\_cp\_async} &  &  &  &  & full & full &  &  &  &  &  & \\
\texttt{Sm80\_generic} &  &  & full & full & full & full &  &  &  &  &  & temp.\\
...
\texttt{cuda\_generic\_and\_async\_proxy} &  &  & full & full & full &  &  &  &  &  &  & full\\
\hline
\end{tabular}
}
