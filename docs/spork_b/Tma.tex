...
See the \lighttt{exo.platforms.Sm90.Sm90\_tma} module for polymorphic TMA instructions.
...
Copies from SMEM to GMEM use the \lighttt{Sm90\_TmaCommitGroup} barrier mechanism (Section~\ref{sec:CommitGroupUsage}).
...
\begin{figure}[h!]
\codehrule
\input{spork_b/multicast_pseudocode.0.tex}
...
\begin{figure}[t!]
\codehrule
\input{spork_b/multicast_tma_excerpt.0.tex}
