...
\lighttt{Arrive} and \lighttt{Await} statements also modify the arrive and await count.
...
\input{spork_b/SyncSemanticsManagedRingBuffer.tex}
\input{spork_b/CamsporkDetails.tex}
