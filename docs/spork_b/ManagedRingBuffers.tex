...
In general, the mapping between device tasks and CUDA clusters (Section~\ref{sec:gCluster}) is unpredictable.
...
\input{spork_b/ManagedRingBufferIndexing.tex}
...
\input{spork_b/ManagedRingBufferSync.tex}
