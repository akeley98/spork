...
A newly-allocated variable has all its array elements initialized to an empty read visibility record set, an empty mutate visibility record set, and 0 arrive and await count, except for managed ring buffer allocations (Section~\ref{sec:SyncSemanticsManagedRingBuffer}).
