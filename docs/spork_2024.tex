...
\node (block0) [smallnode, below=of grid, xshift=-1cm, yshift=-16mm] {block};
...
\draw[dotted] (block1.east) to node[]{gridDim} (block2.west);

\node (thread0) [smallnode, below=of block0, yshift=-4mm] {thread};
\node (thread1) [smallnode, right=of thread0] {thread};
\node (thread2) [smallnode, right=of thread1, xshift=2cm] {thread};
\node (rmem0) [smallnode, below=of thread0] {RMEM};
\node (rmem1) [smallnode, below=of thread1] {RMEM};
\node (rmem2) [smallnode, below=of thread2] {RMEM};
...
\draw[dotted] (thread1.east) to node[]{blockDim} (thread2.west);
\end{tikzpicture}
\end{minipage}
