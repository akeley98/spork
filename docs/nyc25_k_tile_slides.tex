...
\node [yellowstyle, below=of zero, yshift=+3mm, xshift=+6mm] {\Huge $\star$};
\end{tikzpicture}
\end{center}
...
\input{nyc25_no_sync_flow.tex}
\node (text) [below=of B] {\textbf{All steps are thread-block-cooperative.}};
\node [yellowstyle, above=of ab, yshift=+0.2mm] {\Huge $\star$};
\end{tikzpicture}
\end{center}
...
\input{nyc25_no_sync_flow.tex}
\node (text) [below=of B] {\textbf{All steps are thread-block-cooperative.}};
\node [yellowstyle, left=of accum, yshift=+5.5mm, xshift=2mm] {\Huge $\star$};
\end{tikzpicture}
\end{center}
...
\input{nyc25_no_sync_flow.tex}
\node (text) [below=of B] {\textbf{All steps are thread-block-cooperative.}};
\node [yellowstyle, below=of C, yshift=+2mm, xshift=+5mm] {\Huge $\star$};
\end{tikzpicture}
\end{center}
