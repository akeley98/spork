...
Matrix tile reads/writes to \myKeyA{GMEM} are predicated: out-of-bounds writes are discarded; reads return 0 or NaN (configurable).
...
\minorSub{Extra Info: Async Instruction Details}
