...
\graytt{~~~~~~\# even if they are from parallel loops}\\
\blacktt{~~~~~~for ks in cuda\_threads(0, 16, unit=cuda\_thread):}\\
\blacktt{~~~~~~~~for \blueBox{ms} in cuda\_threads(0, 16, unit=cuda\_thread):}\\
\blacktt{~~~~~~~~~~for \blueBox{ns} in cuda\_threads(0, 8, unit=cuda\_thread):}\\
