...
% Latex stupidity: need to escape # as \# in URL.
...
% I'm not sure why these exist instead of section/subsection
\newcommand{\mySection}[1]{{ \vspace{2mm} \section{\large \color{titleColor} \hspace{-12mm} \textbf{\textsf{#1}}} \vspace{2mm}}}
\newcommand{\mySubsection}[1]{{ \subsection{\color{mainColor} \hspace{-9mm} \textsf{#1}}}}
\newcommand{\mySubsectionMinor}[1]{{ \subsection{\color{minorColor} \hspace{-9mm} \textsf{#1}}}}

\newcommand{\myChapterLink}[2]{\textsf{{\color{webColor} \hyperref[#1]{#2}}, page \pageref{#1}}}
...
\newcommand{\useMainSub}{\titleformat*{\subsection}{\color{mainColor}\normalfont\sffamily}}
\newcommand{\useMinorSub}{\titleformat*{\subsection}{\color{minorColor}\normalfont\sffamily}}
\titlespacing{\subsection}{-15mm}{2mm}{1mm}
\useMainSub
\newcommand{\magicSection}[2]{\section{#1 \hfill \small \graytt{#2}}\label{#2}}
\newcommand{\magicSubsection}[2]{\subsection{#1 \hfill \small \graytt{#2}}\label{#2}}
...
\newcommand{\lightsf}[1]{{\color{lightttColor}\textsf{#1}}}
