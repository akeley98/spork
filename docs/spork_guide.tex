...
\filbreak
\lighttt{Arrive} and \lighttt{Await} statements that use the same queue barrier pair with each other, with delay controlled by the \lighttt{N} parameter. For simple usage, $N = 1$ for arrive statements.
