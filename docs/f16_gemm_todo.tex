...
%% \begin{figure}
%% \input{f16_gemm/ldmatrix_usage.0.tex}
%% \caption{\texttt{ldmatrix\_test} should be written so this program works.}
%% \label{fig:ldmatrix_usage}
%% \end{figure}

\subsection{ldmatrix usage}

You should be able to compile and run this program if you write \lighttt{ldmatrix\_test} correctly.
