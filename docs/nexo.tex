...
\begin{itemize}
  \item None: we don't believe anything about the contents of \texttt{A}
...
It's not like the ``just generate CUDA C++'' crowd cares if everything is not proven airtight; we just have to do better.
