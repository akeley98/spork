% python3 code_to_tex.py old_coll_samples.py old_coll_samples && xelatex </dev/null old_coll_algebra.tex
...
\input{old_coll_samples/cuda_threads.0.tex}
...
\input{old_coll_samples/simple.0.tex}
...
\input{old_coll_samples/simple_cxx.0.tex}
...
\input{old_coll_samples/simple.1.tex}
...
\input{old_coll_samples/seq_fail.0.tex}

\filbreak
\mainSub{Negative Example: Mismatched \texttt{CollIndexExpr}}

\input{old_coll_samples/mismatched.0.tex}

\filbreak
\mainSub{Positive Example: Matched \texttt{CollIndexExpr}}

\input{old_coll_samples/matched.0.tex}
...
\input{old_coll_samples/warp_example.0.tex}
...
\input{old_coll_samples/broken_chain.0.tex}
...
\input{old_coll_samples/chain.0.tex}
...
\input{old_coll_samples/chain.1.tex}

\filbreak
\mainSub{Negative Example: Repeated Index}

\input{old_coll_samples/repeated.0.tex}
...
\input{old_coll_samples/repeated.1.tex}
...
\input{old_coll_samples/repeated_cxx.0.tex}

\filbreak
\minorSub{Multiple Tensors}

\input{old_coll_samples/many_tensors.0.tex}
