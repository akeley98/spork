...
\myChapterLink{ch:Multicasting}{Multicasting: mbarriers \& TMA}
...
\newpage
\mySection{Multicasting: mbarriers \& TMA}
...
\begin{itemize}
  ...
  \filbreak
  \item Extend the mbarrier pairing requirement to handle TMA [see \myChapterLink{ch:Multicasting}{Multicasting: mbarriers \& TMA}]
\end{itemize}
