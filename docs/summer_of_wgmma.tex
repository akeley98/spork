...
\begin{document}
\myTitle{Summer Plans for Spork \yellowBox{OUTDATED}}
...
\newpage
\section{Instrs \& Distributed Memory}
\label{ch:Instrs}
...
\newpage
\section{Timelines \& Synchronization}
\label{ch:Timelines}
...
\newpage
\section{Multicasting mbarriers}
...
\newpage
\section{TMA Instruction Barrier Parameter}
\label{ch:tma}
...
\newpage
\section{Exo mbarrier Pairing Requirement}
\label{ch:mbarrier}
...
\newpage
\section{Abstract Machine Grammar}
